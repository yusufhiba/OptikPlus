    ...
    <ul class="nav navbar-nav">
      <li class="dropdown, active"><a class="dropdown-toggle" data-toggle="dropdown" href="#">Home <span class="caret"></span></a>
        <ul class="dropdown-menu">
          <li><a href="indexK.php">Kasir 1</a></li>
          <li class="active"><a href="index_kasir2.php">Kasir 2</a></li>
        </ul>
      </li>
...
-->
    ...
    <table style="width:60%; border:4px solid maroon; ">
        ...
        <caption style="text-align: left; font-size: 40px; color: black;">Kasir CITO</caption>
        <tr>
            <th>Nomer</th>
            <th>Tanggal</th>
